...
class DesignKeyHandlerService {
  constructor($rootScope, drillEditorService, eventService) {
  ...
  leftArrow(e) {
    ...
    if (e.shiftKey) {
      this.drillEditorService.reverseStep(
        this.reverseOriginCount - this.reverseCounter, // eslint-disable-line max-len
...
angular
  .module('drillApp')
  .service('designKeyHandlerService', ['$rootScope', 'drillEditorService', 'eventService', DesignKeyHandlerService]);
