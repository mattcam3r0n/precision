...
angular.module('drillApp').component('addStepsTool', {
  templateUrl:
    'client/design/designSurface/addStepsTool/addStepsTool.view.ng.html',
  bindings: {},
  controller: function(
    $scope,
    drillEditorService,
    ...
    function initStrideTypeSwitch() {
      ...
      $('[name=\'stride-type-switch\']').bootstrapSwitch(
        'state',
        drillEditorService.strideType
      );
      $('input[name=\'stride-type-switch\']').on(
