...
angular.module('drillApp').component('audioClipDialog', {
  templateUrl:
    'client/design/designSurface/audioClipDialog/audioClipDialog.view.ng.html',
  bindings: {
    drill: '<',
  },
  controller: function(
    ...
    ctrl.isSavable = function() {
      return (
        ...
        ctrl.isValid() &&
        (ctrl.musicFile.type == 'clip' || ctrl.selection != null)
      );
    };
    ...
    function normalizeBeats(beats) {
      ...
      let cumulativeTime =
        newBeats.length > 0 ? newBeats[newBeats.length - 1].timeOffset : 0;
      const timeInterval = 60 / ctrl.tempo;
      ...
      ctrl.wavesurfer = WaveSurfer.create({
        ...
        plugins: [
          TimelinePlugin.create({
            ...
            timeInterval:
              (musicFile.fileDuration || musicFile.duration) < 5 ? 0.1 : 5,
          }),
