...
angular.module('drillApp').component('timeline', {
  ...
  controller: function(
    ...
    ctrl.$onInit = function() {
      ...
      ctrl.subscriptions.subscribe(
        Events.drillScheduleRecalculated,
        onDrillScheduleRecalculated
      );
      ctrl.subscriptions.subscribe(
        Events.drillStateChanged,
        onDrillStateChanged
      );
      ctrl.subscriptions.subscribe(Events.drillOpened, onDrillOpened);
      ctrl.subscriptions.subscribe(Events.musicChanged, onMusicChanged);
      ctrl.subscriptions.subscribe(Events.bookmarkChanged, onBookmarkChanged);
    ...
    function onDrillScheduleRecalculated(evt, args) {
      setItems();
    }
